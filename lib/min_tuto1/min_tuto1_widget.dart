                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Hola! Bienvenido a PlantMex, en esta aplicación visualizaras plantas  junto a sus datos cientificos, al igual que podras visualizar algunas recetas medicinales esto con el fin de poder apoyar a diferentes personas.',
                                            textAlign: TextAlign.center,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'En esta aplicación podras visualizar diferentes plantas, de acuerdo a su clasisificación en las que se encuentran',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText2
                                                .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'La aplicacion tambien cuenta con una sección de recetas en la cuel explica como prepararlas al igual el uso de cada una',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText2
                                                .override(
