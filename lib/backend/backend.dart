...
import 'schema/inf_plant_record.dart';
...
export 'schema/inf_plant_record.dart';
...
/// Functions to query InfPlantRecords (as a Stream and as a Future).
Stream<List<InfPlantRecord>> queryInfPlantRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      InfPlantRecord.collection,
...
Future<List<InfPlantRecord>> queryInfPlantRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<InfPlantRecord>> queryInfPlantRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
